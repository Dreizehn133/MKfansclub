 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/ExTBpeSERVER/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ExTBpeSERVER/NewWebService?WSDL");
